...
/**
 * CHATBOT ENGINE - ROLE-BASED SYSTEM
 * 
 * Hỗ trợ cả Bệnh nhân và Bác sĩ với 21 intents
 * Tích hợp đầy đủ với các activity thực tế
 */
public class ChatbotEngine {
    ...
    /**
     * MAIN PROCESSING - ROLE-BASED với NLU cải tiến
     */
